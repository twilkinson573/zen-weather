...
/***/ function(module, exports, __webpack_require__) {
	...
	var LocationSearch = __webpack_require__(227);

	var LocationSearchContainer = React.createClass({
	  displayName: 'LocationSearchContainer',
	...
	var LocationOverviewContainer = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ContentWrapper,
	      null,
	      React.createElement(LocationOverview, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function LocationOverviewHeader(props) {
	  return React.createElement(
	    'h2',
	    null,
	    weatherHelpers.locationName(props.locationResult)
	  );
	}
	...
	function CurrentSummary(props) {
	  return React.createElement(
	    ...
	    React.createElement(
	      'p',
	      null,
	      props.currentForecast.weather[0].description
	    ),
	    React.createElement(
	      'h2',
	      null,
	      weatherHelpers.currentTemp(props.currentForecast.main.temp),
	      '°'
	    )
	  );
	}
	...
	function ShortForecast(props) {
	  return React.createElement(
	    'div',
	    { className: 'col-sm-2', key: props.key },
	    React.createElement(
	      'h6',
	      null,
	      weatherHelpers.displayTime(props.data.dt_txt)
	    ),
	    React.createElement(
	      'p',
	      null,
	    ...
	    React.createElement(
	      'p',
	      null,
	      weatherHelpers.currentTemp(props.data.main.temp),
	      '°'
	    )
	  );
	}
	...
	function LocationOverview(props) {
	  return props.isLoading === true ? React.createElement(
	    ...
	    React.createElement(
	      'div',
	      { className: 'col-sm-12' },
	      React.createElement(LocationOverviewHeader, { locationResult: props.locationForecast.city }),
	      React.createElement(CurrentSummary, { currentForecast: props.locationForecast.list[0] })
	    ),
	    React.createElement(
	      'div',
	      { className: 'row' },
	      props.locationForecast.list.slice(0, 6).map(function (datapoint, i) {
	        return React.createElement(ShortForecast, { data: datapoint, key: i });
	      })
	    ),
	    React.createElement(
	      'div',
	      { className: 'temp' },
	      weatherHelpers.getDayForecasts(props.locationForecast.list.slice(6, props.locationForecast.list.length)).map(function (datapoint, i) {
	        return React.createElement(
	          'div',
	          { className: 'row', key: i },
	          React.createElement(
	            ...
	            React.createElement(
	              'p',
	              null,
	              weatherHelpers.getWeekday(Object.keys(datapoint))
	            )
	          ),
	          React.createElement(
	            'div',
	            ...
	            React.createElement(
	              'p',
	              null,
	              datapoint[Object.keys(datapoint)[0]].weather
	            )
	          ),
	          React.createElement(
	            'div',
	            ...
	            React.createElement(
	              'p',
	              null,
	              weatherHelpers.currentTemp(datapoint[Object.keys(datapoint)[0]].temp)
	            )
	          )
	        );
	      })
